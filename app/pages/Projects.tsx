          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {projects.map((project) => (
              ...
              >
                ...
                {/* Hover Overlay */}
                <div className="absolute inset-0 bg-white/95 dark:bg-neutral-900/95 p-8 opacity-0 group-hover:opacity-100 transition-all duration-300 flex flex-col justify-center overflow-y-auto">
